...
\begin{equation}
\begin{align*}
   \frac{\partial \hat{A}_{ij}}{\partial t} &= -\frac{\partial}{\kappa \hat{A}_{ij} \bar{U_k} + \kappa_k \bar{A}_{ij} \hat{u}_k  + \bar{W}_{ik} \hat{A}_{kj} + \hat{W}_{ik} \bar{A}_{kj}  - \bar{A}_{ik} \hat{W}_{kj} 
  \\ 
