...
\begin{frame}{Shear bands and boudinage}
   ...
   \column{0.6\textwidth}
   \begin{itemize}
      \item Under horizontal simple shear, c-axes go to vertical/basal planes horizontal - Soft because the shear is along the basal plane
...
\column{0.4\textwidth}
\begin{figure*}
   \includegraphics[width=1\textwidth]{grip_gillet}
