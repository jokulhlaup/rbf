...
\end{itemize}
   \begin{figure}
      \includegraphics[height=0.3\textheight]{gisp2}
...
\begin{frame}{Observed statigraphic disturbances}
   \begin{columns}[T]
    ...
    \item What can cause this?
     ...
     \column{0.6\textwidth}
     \begin{figure}
     \includegraphics[width=0.7\textwidth]{z_fold}
...
\begin{frame}{Ice is very anisotropic}
  ...
  \end{itemize}
    \column{0.6\textwidth}
  \begin{figure}
     \includegraphics[width=0.8\textheight]{ice}
...
\begin{frame}{Ice is very anisotropic}
\begin{figure}
     \includegraphics[width=0.7\textheight]{poly}
...
\end{itemize}
   \begin{figure}
      \includegraphics[width=0.9\textwidth]{shear_band}
...
\end{itemize} 
\begin{figure*}
   \includegraphics[height=0.45\textheight]{grip_gillet}
...
\begin{frame}{Setup and perturbations}
   ...
   \end{itemize}
%   \begin{block}{Perturbed quantities}
%   \begin{aligned}
