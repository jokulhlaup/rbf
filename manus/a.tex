...
The most important process governing the formation of crystal fabrics is deformation-induced grain rotation. Grain rotation is described using a Jefferys equation \citep{azuma94}:
\[
   \dot{c} = \zeta \( \W \cdot c + D \cdot c + c c^T \cdot D \cdot c \)
\],
